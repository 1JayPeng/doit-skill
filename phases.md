...
**[LOAD] [shared/phase-gate.md](shared/phase-gate.md) — Phase Gate Checklist at end of any phase.**

**Progressive disclosure:** The Phase Gate Checklist has been moved to [shared/phase-gate.md](shared/phase-gate.md). Load it at the end of any phase to verify workflow completeness. This file is ~80 lines — loading it per-phase instead of baking it into phases.md saves 80 lines × N phase transitions.
